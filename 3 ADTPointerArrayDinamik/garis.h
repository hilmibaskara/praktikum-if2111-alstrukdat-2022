...
// Kalo ini udah diassign ke Garis L dari prosedurnya
// Kalo misal GARIS MakeGaris(..,..) ngereturn data type garis yang perlu diassign ke variable
// contohnya g = GARIS MakeGaris(..,..)
